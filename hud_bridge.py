...
class JarvisHUD(QMainWindow):
    def __init__(self):
        ...
        self.command_input.setStyleSheet(
            "QLineEdit { background:#071521; color:#dffaff; border:1px solid #2abbdf; border-radius:8px; padding:10px; font-size:15px; }"
        )
        self.execute_button = QPushButton("RUN")
        self.execute_button.setStyleSheet(
            "QPushButton { background:#0c7ea3; color:white; border:none; border-radius:8px; padding:10px 18px; font-weight:700; }"
        )
